...
\end{problem}
\begin{solution}
    % the only way there can exist a stationary distribution here is if the initial probability at any state is constant which is not possible on the state space Z. Thus, there cannot be a stationary distributino. 
